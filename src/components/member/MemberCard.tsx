        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-6"> */}
                ...
                {members.map((member, index) => (
                    <div
                        key={index}
                        className="border border-gray-200 rounded-xl bg-gradient-to-b from-white to-gray-50 px-6 py-6 flex flex-col justify-between shadow-lg hover:shadow-2xl hover:-translate-y-2 transform transition duration-300 ease-in-out"
                    >
                        <div className="mb-6">
                            ...
                            <div className="bg-white rounded-lg p-4 mb-4 shadow-outer border border-gray-100">
                            ...
                            <div className="text-center my-4">
                                ...
                                <p className="text-2xl font-bold text-gray-800">
                                    ...
                                    <span className="text-xs font-normal text-gray-500">/minggu</span>
                                </p>
                            </div>
                        </div>
                        <button
                            onClick={() => handleSelectPackage(member.locationId, member.sportName, member.membershipId)}
                            className="w-full bg-gradient-to-r from-lime-300 to-lime-400 text-black font-semibold py-3 rounded-lg hover:from-lime-400 hover:to-lime-500 transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-lime-400 focus:ring-opacity-50"
                        >
                            Pilih Paket
                        </button>
                    </div>
