    ...
    <PageContainer>
      <div className='flex flex-1 flex-col space-y-2'>
        ...
        <div className='*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs md:grid-cols-2 lg:grid-cols-3'>
          <Card className='@container/card'>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              ...
              <div className='text-muted-foreground'>
                Jumlah lapangan cabang
              </div>
            </CardFooter>
          </Card>
          <Card className='@container/card'>
            <CardHeader>
              <CardDescription>Total Jenis Paket Member</CardDescription>
          ...
          <Card className='@container/card'>
            <CardHeader>
              <CardDescription>Total pesanan member</CardDescription>
              <CardTitle className='text-2xl font-semibold tabular-nums @[250px]/card:text-3xl'>
                45
              </CardTitle>
              <CardAction>
            ...
            <CardFooter className='flex-col items-start gap-1.5 text-sm'>
              ...
              <div className='text-muted-foreground'>
                Jumlah pesanan paket member bulan ini
              </div>
            </CardFooter>
          </Card>
